...
const BreweryModal = ({brewery}) => {
  ...
  <Modal trigger={
    ...
    <Modal.Content image>
      ...
      <Image wrapped size='medium' src={infoImg} />
      <Modal.Description>
